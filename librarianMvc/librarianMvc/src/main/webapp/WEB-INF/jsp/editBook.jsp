...
<body>
	...
	<div class="center">
		<h4 style="text-align: center;">Edit Book Details</h4>
		<form class="container mt-3" style="height: 40px; width: 400px;"
			action="editForm" method="post">


			<div class="form-group">
				<label for="id">Book Code</label><input type="text" name="id" required  class="form-control"
					value="${book.getId()}" />
			</div>
